...
export const Header = () => {
  return (
    <header className="flex items-center justify-between w-full max-w-[1110px] mx-auto min-h-16 px-2.5">
      <Link to="/" className="w-[85px] h-[30px]">
        <img
          className="w-full h-full object-contain object-center"
          src="/public/logo.svg"
        />
      </Link>
      <div className="flex items-end gap-8 pr-2">
